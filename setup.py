...
setup(
    name='Cistopic',  # Required. Your package's name.
    ...
    description='Topic modeling for scATAC-seq data',  # Required. A short description of your package.
    ...
    url='https://github.com/Nour899/cisTopic.git',  # Optional. The URL to your package's repository or website.
